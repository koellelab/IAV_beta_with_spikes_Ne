...
- `01_Rscripts` contains all functions used in this project, the major one being `WithinhostIAV_Ne_fnuctions_log.R`, as well as the scripts used to generate each figure in the paper mentioned above.
- `02_plots` contains the original figures generated and are identical to the figures in the paper mentioned above.
- `03_data` contains all datasets being used.
