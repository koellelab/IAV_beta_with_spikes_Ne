...
# export table S1
table_S1_d0 <- McCrone_IAV_flumina_data[, c("ID", "iSNV", "DPS1", "DPS2", "freq1", "freq2", "Subset")]
colnames(table_S1_d0) <- c("Individual ID", "iSNV", "DPS1", "DPS2", "DPS1 Frequency", "DPS2 Frequency", "Subset")

write.csv(table_S1_d0, "03_data/table_S1_rep.csv", row.names = FALSE, quote = FALSE)
