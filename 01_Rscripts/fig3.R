...
fig3b <- ggplot(LLdf_McCrone_freq0.02) +
  ...
  annotate("text", x = 750, y = -65, label = paste("N[E] == ", MLE_Ne_McCrone_freq0.02), parse = TRUE, color = "red", size = 6) +
  ...
  labs(x = expression(N[E]), y = "Log-likelihood", title = expression(paste(threshold, "= 2%"))) 
...
fig3c <- ggplot(LLdf_McCrone_freq0.005) +
  ...
  annotate("text", x = 300, y = -85, label = paste("N[E] == ", MLE_Ne_McCrone_freq0.005), parse = TRUE, color = "red", size = 6) +
  annotate("rect", xmin = as.numeric(CI_low_Ne_freq0.005), xmax = as.numeric(CI_high_Ne_freq0.005), 
           ymin = -Inf, ymax = Inf, alpha = 0.1,fill = "black") +
  labs(x = expression(N[E]), y = "Log-likelihood", title = expression(paste(threshold, "= 0.5%"))) 
...
fig3e <- ggplot(LLdf_McCrone_freq0.02_gen1) +
  ...
  annotate("text", x = 100, y = -90, label = paste("N[E] == ", MLE_Ne_McCrone_freq0.02_gen1), parse = TRUE, color = "red", size = 6) +
...
fig3f <- ggplot(LLdf_McCrone_freq0.005_gen1) +
  ...
  annotate("text", x = 30, y = -450, label = paste("N[E] == ", MLE_Ne_McCrone_freq0.005_gen1), parse = TRUE, color = "red", size = 6) +
...
ggsave(fig3, file = "fig3.pdf", path = "02_plots", width = 15, height = 8)
